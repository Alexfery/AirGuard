...
function NavbarComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(5, "mat-divider", 17);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.auth.currentUser().name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.auth.currentUser().email);
  }
}
var NavbarComponent = class _NavbarComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavbarComponent, selectors: [["app-navbar"]], inputs: { sidenavOpen: "sidenavOpen" }, outputs: { toggleSidenav: "toggleSidenav" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 29, vars: 5, consts: [["userMenu", "matMenu"], [1, "navbar"], ["mat-icon-button", "", "matTooltip", "Toggle meniu", 1, "menu-btn", 3, "click"], [1, "navbar-brand"], [1, "brand-icon"], [1, "spacer"], [1, "navbar-status"], [1, "live-indicator"], [1, "live-dot"], [1, "live-text"], ["mat-icon-button", "", "matTooltip", "Notific\u0103ri", "routerLink", "/history"], ["matBadgeColor", "warn", "matBadgeSize", "small", 3, "matBadge"], ["mat-icon-button", "", "matTooltip", "Cont utilizator", 3, "matMenuTriggerFor"], [1, "avatar-btn"], [1, "user-menu"], ["mat-menu-item", "", 3, "click"], [1, "menu-user-info"], [2, "margin", "4px 0"]], template: function NavbarComponent_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = \u0275\u0275getCurrentView();
        ...
        \u0275\u0275text(14, "LIVE");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(15, "button", 10)(16, "mat-icon", 11);
        \u0275\u0275text(17, "notifications_outlined");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(18, "button", 12)(19, "div", 13);
        \u0275\u0275text(20);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(21, "mat-menu", 14, 0);
        \u0275\u0275template(23, NavbarComponent_Conditional_23_Template, 6, 2);
        ...
        \u0275\u0275text(28, "Deconectare");
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        let tmp_4_0;
        const userMenu_r3 = \u0275\u0275reference(22);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(ctx.sidenavOpen ? "menu_open" : "menu");
        \u0275\u0275advance(13);
        \u0275\u0275property("matBadge", "3");
        \u0275\u0275advance(2);
        \u0275\u0275property("matMenuTriggerFor", userMenu_r3);
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate1(" ", ((tmp_4_0 = ctx.auth.currentUser()) == null ? null : tmp_4_0.name == null ? null : (tmp_4_0 = tmp_4_0.name.charAt(0)) == null ? null : tmp_4_0.toUpperCase()) || "U", " ");
        \u0275\u0275advance(3);
        \u0275\u0275conditional(23, ctx.auth.currentUser() ? 23 : -1);
      }
    }, dependencies: [RouterLink, MatToolbarModule, MatToolbar, MatButtonModule, MatIconButton, MatIconModule, MatIcon, MatMenuModule, MatMenu, MatMenuItem, MatMenuTrigger, MatBadgeModule, MatBadge, MatTooltipModule, MatTooltip, MatDividerModule, MatDivider], styles: ["\n\n.navbar[_ngcontent-%COMP%] {\n  background: var(--bg-sidebar) !important;\n  border-bottom: 1px solid var(--border);\n  height: 56px;\n  min-height: 56px;\n  padding: 0 8px;\n  position: sticky;\n  top: 0;\n  z-index: 100;\n}\n.navbar[_ngcontent-%COMP%]   .menu-btn[_ngcontent-%COMP%] {\n  color: var(--text-secondary);\n  margin-right: 4px;\n}\n.navbar[_ngcontent-%COMP%]   .navbar-brand[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  font-size: 18px;\n  font-weight: 600;\n  color: var(--text-primary);\n}\n.navbar[_ngcontent-%COMP%]   .navbar-brand[_ngcontent-%COMP%]   .brand-icon[_ngcontent-%COMP%] {\n  color: var(--accent);\n  font-size: 22px;\n  width: 22px;\n  height: 22px;\n}\n@media (min-width: 768px) {\n  .navbar[_ngcontent-%COMP%]   .navbar-brand[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n.navbar[_ngcontent-%COMP%]   .spacer[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.navbar[_ngcontent-%COMP%]   .navbar-status[_ngcontent-%COMP%] {\n  margin-right: 8px;\n}\n.navbar[_ngcontent-%COMP%]   .navbar-status[_ngcontent-%COMP%]   .live-indicator[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  background: rgba(76, 175, 80, 0.1);\n  border: 1px solid rgba(76, 175, 80, 0.3);\n  border-radius: 12px;\n  padding: 4px 10px;\n}\n.navbar[_ngcontent-%COMP%]   .navbar-status[_ngcontent-%COMP%]   .live-indicator[_ngcontent-%COMP%]   .live-dot[_ngcontent-%COMP%] {\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  background: var(--accent-green);\n  animation: pulse 2s infinite;\n}\n.navbar[_ngcontent-%COMP%]   .navbar-status[_ngcontent-%COMP%]   .live-indicator[_ngcontent-%COMP%]   .live-text[_ngcontent-%COMP%] {\n  font-size: 11px;\n  font-weight: 600;\n  color: var(--accent-green);\n  letter-spacing: 1px;\n}\n.navbar[_ngcontent-%COMP%]   .avatar-btn[_ngcontent-%COMP%] {\n  width: 32px;\n  height: 32px;\n  border-radius: 50%;\n  background:\n    linear-gradient(\n      135deg,\n      var(--accent),\n      #0097a7);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-weight: 700;\n  font-size: 13px;\n  color: white;\n}\n.menu-user-info[_ngcontent-%COMP%] {\n  padding: 12px 16px 8px;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.menu-user-info[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%] {\n  font-size: 14px;\n  color: var(--text-primary);\n}\n.menu-user-info[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  font-size: 12px;\n  color: var(--text-secondary);\n}\n/*# sourceMappingURL=navbar.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavbarComponent, { className: "NavbarComponent", filePath: "src/app/shared/components/navbar/navbar.component.ts", lineNumber: 22 });
})();
...
function ShellComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 8)(1, "mat-icon", 15);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", item_r1.route)("matTooltip", item_r1.label);
    \u0275\u0275advance(2);
...
function ShellComponent_Conditional_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r1.auth.currentUser().name.charAt(0).toUpperCase(), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.auth.currentUser().name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.auth.currentUser().email);
...
var ShellComponent = class _ShellComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShellComponent, selectors: [["app-shell"]], hostBindings: function ShellComponent_HostBindings(rf, ctx) {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 26, vars: 4, consts: [[1, "shell-container"], [1, "shell-sidenav", 3, "closedStart", "mode", "opened"], [1, "sidenav-header"], [1, "logo"], [1, "logo-icon"], [1, "logo-text"], [1, "logo-tagline"], [1, "nav-list"], ["mat-list-item", "", "routerLinkActive", "nav-active", "matTooltipPosition", "right", 3, "routerLink", "matTooltip"], [1, "sidenav-footer"], [1, "user-info"], ["mat-button", "", "matTooltip", "Deconectare", 1, "logout-btn", 3, "click"], [1, "shell-content"], [3, "toggleSidenav", "sidenavOpen"], [1, "main-content"], ["matListItemIcon", ""], ["matListItemTitle", ""], [1, "user-avatar"], [1, "user-details"], [1, "user-name"], [1, "user-email"]], template: function ShellComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "mat-sidenav-container", 0)(1, "mat-sidenav", 1);
        \u0275\u0275listener("closedStart", function ShellComponent_Template_mat_sidenav_closedStart_1_listener() {
        ...
        \u0275\u0275text(9, "Monitorizare calitate aer");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(10, "mat-divider");
        \u0275\u0275elementStart(11, "mat-nav-list", 7);
        \u0275\u0275repeaterCreate(12, ShellComponent_For_13_Template, 5, 4, "a", 8, _forTrack0);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(14, "div", 9);
        \u0275\u0275element(15, "mat-divider");
        \u0275\u0275template(16, ShellComponent_Conditional_16_Template, 8, 3, "div", 10);
        ...
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(22, "mat-sidenav-content", 12)(23, "app-navbar", 13);
        \u0275\u0275listener("toggleSidenav", function ShellComponent_Template_app_navbar_toggleSidenav_23_listener() {
          return ctx.toggleSidenav();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(24, "main", 14);
        \u0275\u0275element(25, "router-outlet");
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance();
        \u0275\u0275property("mode", ctx.isMobile() ? "over" : "side")("opened", ctx.sidenavOpen());
        \u0275\u0275advance(11);
        \u0275\u0275repeater(ctx.navItems);
        \u0275\u0275advance(4);
        \u0275\u0275conditional(16, ctx.auth.currentUser() ? 16 : -1);
        \u0275\u0275advance(7);
        \u0275\u0275property("sidenavOpen", ctx.sidenavOpen());
      }
    }, dependencies: [
      RouterOutlet,
      RouterLink,
      ...
      MatDividerModule,
      NavbarComponent
    ], styles: ["\n\n.shell-container[_ngcontent-%COMP%] {\n  height: 100vh;\n  background: var(--bg-primary);\n}\n.shell-sidenav[_ngcontent-%COMP%] {\n  width: 240px;\n  background: var(--bg-sidebar) !important;\n  border-right: 1px solid var(--border) !important;\n}\n.sidenav-header[_ngcontent-%COMP%] {\n  padding: 24px 20px 16px;\n}\n.sidenav-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  margin-bottom: 4px;\n}\n.sidenav-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]   .logo-icon[_ngcontent-%COMP%] {\n  color: var(--accent);\n  font-size: 28px;\n  width: 28px;\n  height: 28px;\n}\n.sidenav-header[_ngcontent-%COMP%]   .logo[_ngcontent-%COMP%]   .logo-text[_ngcontent-%COMP%] {\n  font-size: 22px;\n  font-weight: 700;\n  color: var(--text-primary);\n  letter-spacing: 0.5px;\n}\n.sidenav-header[_ngcontent-%COMP%]   .logo-tagline[_ngcontent-%COMP%] {\n  font-size: 11px;\n  color: var(--text-secondary);\n  padding-left: 38px;\n}\n.nav-list[_ngcontent-%COMP%] {\n  padding: 8px 0;\n}\n.nav-list[_ngcontent-%COMP%]   a[mat-list-item][_ngcontent-%COMP%] {\n  border-radius: 8px;\n  margin: 2px 8px;\n  color: var(--text-secondary);\n  transition: all 0.2s ease;\n}\n.nav-list[_ngcontent-%COMP%]   a[mat-list-item][_ngcontent-%COMP%]:hover {\n  background: rgba(38, 198, 218, 0.08) !important;\n  color: var(--text-primary);\n}\n.nav-list[_ngcontent-%COMP%]   a[mat-list-item][_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: inherit;\n}\n.nav-list[_ngcontent-%COMP%]   .nav-active[_ngcontent-%COMP%] {\n  background: rgba(38, 198, 218, 0.15) !important;\n  color: var(--accent) !important;\n}\n.nav-list[_ngcontent-%COMP%]   .nav-active[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  color: var(--accent) !important;\n}\n.sidenav-footer[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  padding-bottom: 8px;\n}\n.sidenav-footer[_ngcontent-%COMP%]   .user-info[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 16px 16px 8px;\n}\n.sidenav-footer[_ngcontent-%COMP%]   .user-avatar[_ngcontent-%COMP%] {\n  width: 36px;\n  height: 36px;\n  border-radius: 50%;\n  background:\n    linear-gradient(\n      135deg,\n      var(--accent),\n      #0097a7);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-weight: 700;\n  font-size: 14px;\n  color: white;\n  flex-shrink: 0;\n}\n.sidenav-footer[_ngcontent-%COMP%]   .user-details[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n}\n.sidenav-footer[_ngcontent-%COMP%]   .user-name[_ngcontent-%COMP%] {\n  font-size: 13px;\n  font-weight: 500;\n  color: var(--text-primary);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.sidenav-footer[_ngcontent-%COMP%]   .user-email[_ngcontent-%COMP%] {\n  font-size: 11px;\n  color: var(--text-secondary);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.sidenav-footer[_ngcontent-%COMP%]   .logout-btn[_ngcontent-%COMP%] {\n  width: 100%;\n  color: var(--text-secondary);\n  justify-content: flex-start;\n  padding: 4px 16px;\n  gap: 8px;\n  border-radius: 0;\n}\n.sidenav-footer[_ngcontent-%COMP%]   .logout-btn[_ngcontent-%COMP%]:hover {\n  background: rgba(244, 67, 54, 0.1);\n  color: var(--accent-red);\n}\n.sidenav-footer[_ngcontent-%COMP%]   .logout-btn[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 20px;\n}\n.sidenav-footer[_ngcontent-%COMP%]   .logout-btn[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  font-size: 13px;\n}\n.shell-content[_ngcontent-%COMP%] {\n  background: var(--bg-primary);\n  display: flex;\n  flex-direction: column;\n}\n.main-content[_ngcontent-%COMP%] {\n  flex: 1;\n  overflow: auto;\n}\n/*# sourceMappingURL=shell.component.css.map */"] });
  }
};
(() => {
